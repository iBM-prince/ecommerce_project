-- CHARGEMENT DONNEES UTILISATEURS --
 ...
 LOAD DATA LOCAL INFILE 'C:/Users/lenovo/ecommerce_project/sql/csv/utilisateurs.csv' 
...
-- CHARGEMENT DONNEES PATIENTS --
 LOAD DATA LOCAL INFILE 'C:/Users/lenovo/ecommerce_project/sql/csv/patients.csv' 
...
-- CHARGEMENT DONNEES MEDECINS --
 LOAD DATA LOCAL INFILE 'C:/Users/lenovo/ecommerce_project/sql/csv/medecins.csv' 
...
-- CHARGEMENT DONNEES RENDEZ_VOUS --
 LOAD DATA LOCAL INFILE 'C:/Users/lenovo/ecommerce_project/sql/csv/rendez_vous.csv' 
...
-- CHARGEMENT DONNEES HOSPITALISATIONS --
 LOAD DATA LOCAL INFILE 'C:/Users/lenovo/ecommerce_project/sql/csv/hospitalisations.csv' 
...
-- CHARGEMENT DONNEES TRAITEMENTS --
 LOAD DATA LOCAL INFILE 'C:/Users/lenovo/ecommerce_project/sql/csv/traitements.csv' 
